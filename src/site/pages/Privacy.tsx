    ...
    <div>
      <section className="pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <h1 className="text-5xl mb-8">Datenschutz</h1>
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
              ...
              <section>
                ...
                <p>
                  ...
                  Ihrem Profilnamen und Ihrem Foto in Google-Diensten, wie etwa
                  in Suchergebnissen oder in Ihrem Google-Profil, oder an
                ...
                <p>
                  ...
                  +1-Aktivitäten der Nutzer bzw. gibt diese an Nutzer und
              ...
              <section>
                ...
                <p>
                  ...
                  LinkedIn anklicken und in Ihrem Account bei LinkedIn
              ...
              <section>
                ...
                <p>
                  ...
                  Funktionen von Xing enthält, wird eine Verbindung zu Servern
                  von Xing hergestellt. Eine Speicherung von personenbezogenen
                  Daten erfolgt dabei nach unserer Kenntnis nicht. Insbesondere
