...
/**
 * Marken-Icons als Inline-SVG.
 * lucide-react hat Brand-Icons (Facebook, Instagram, ...) ab v1 aus
 * markenrechtlichen Gruenden entfernt – daher hier selbst bereitgestellt.
 */
